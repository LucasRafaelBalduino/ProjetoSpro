...
<div class="container">
	<div class="form-row">
		...
		<div class="col-md-4">
			SENHA: <i class="fa fa-map"></i>
			<input class="form-control" type="password" name="senha" required value="<?=$client_info['']?>"><br>
		</div>

<div class="container">
  <form>
    <label class="checkbox-inline">
      <input type="checkbox" value="user"name="desc_acesso">Usuário
    </label>
    <label class="checkbox-inline">
      <input type="checkbox" value="admin" name="desc_acesso">Administrador
    </label>
  </form>
